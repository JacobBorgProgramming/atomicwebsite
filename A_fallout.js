...
var q1 = a2 + Math.floor(Math.random() * 101);
var q2 = Math.floor(Math.random() * 101);
var q3 = "#"+a1 + Math.floor(Math.random() * 1001) + 'agF';
...
var q7 =  a1 + Math.floor(Math.random() * 11);
var q8 = new Date();
var q9 = q8.getDate();
var q10 = q8.getMonth();
...
if (navigator.cookieEnabled === false){
  ...
  document.getElementById("jsC1").innerHTML = (q1+f3+c1+f1+f2+c2+f4+a3);
